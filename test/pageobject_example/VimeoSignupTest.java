...
public class VimeoSignupTest {
	...
	/** Initialized class properties before executing this class. */ 
	@BeforeClass
	...
	public void testSignupInvalidEmailErrors(){
		...
		String inValidEmail = "ram.email.com"; 
	...
	private void getTestingData(){		
		...
		first_and_LastName = "ram" + randomID + " " + "kumar"; 
		email = "ramkumar" + randomID + "@yahoo.com"; 
